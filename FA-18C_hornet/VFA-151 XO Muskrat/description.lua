livery = {
	...
	{"pilot_F18_helmet", 0, "PILOT_F18_HELMET_VFA_151_CO", false};
	{"pilot_F18_helmet", 13, "PILOT_F18_HELMET_VFA_151_CO_RoughMet", false};
	
	--Fuel Tanks
	--{"FPU_8A", 0 ,"FPU_8A_Vigilantes_CO",false};
...
name = "VFA-151 Vigilantes XO Muskrat"
countries = {"USA",}
